# Demo 1
```
az group create --name my-demo --location eastus

az deployment group create --resource-group my-demo --template-file ubuntu.json --parameters ubuntu.parameters.json

```

# Launch Ubuntu VM in azure portal & connect to it
# Launch Windows VM in azire portal and perform RDP to it
